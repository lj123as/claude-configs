...
- **[Tech Lead Orchestrator](tech-lead-orchestrator.md)** - Senior technical lead who analyzes complex projects and coordinates multi-step development tasks
- **[Project Analyst](action/Product-development/development/prompt/awesome-claude-agents/agents/orchestrators/project-analyst.md)** - Technology stack detection specialist who enables intelligent agent routing
- **[Team Configurator](action/Product-development/development/prompt/awesome-claude-agents/agents/orchestrators/team-configurator.md)** - AI team setup expert who detects your stack and configures optimal agent mappings

### 💼 Framework Specialists (13 agents)
- **Laravel (2 agents)**
  - **[Backend Expert](laravel-backend-expert.md)** - Comprehensive Laravel development with MVC, services, and Eloquent patterns
  - **[Eloquent Expert](laravel-eloquent-expert.md)** - Advanced ORM optimization, complex queries, and database performance
- **Django (3 agents)**
  - **[Backend Expert](django-backend-expert.md)** - Models, views, services following current Django conventions
  - **[API Developer](django-api-developer.md)** - Django REST Framework and GraphQL implementations
  - **[ORM Expert](django-orm-expert.md)** - Query optimization and database performance for Django applications
- **Rails (3 agents)**
  - **[Backend Expert](rails-backend-expert.md)** - Full-stack Rails development following conventions
  - **[API Developer](rails-api-developer.md)** - RESTful APIs and GraphQL with Rails patterns
  - **[ActiveRecord Expert](rails-activerecord-expert.md)** - Complex queries and database optimization
- **React (2 agents)**
  - **[Component Architect](react-component-architect.md)** - Modern React patterns, hooks, and component design
  - **[Next.js Expert](react-nextjs-expert.md)** - SSR, SSG, ISR, and full-stack Next.js applications
- **Vue (3 agents)**
  - **[Component Architect](vue-component-architect.md)** - Vue 3 Composition API and component patterns
  - **[Nuxt Expert](vue-nuxt-expert.md)** - SSR, SSG, and full-stack Nuxt applications
  - **[State Manager](vue-state-manager.md)** - Pinia and Vuex state architecture

### 🌐 Universal Experts (4 agents)
- **[Backend Developer](backend-developer.md)** - Polyglot backend development across multiple languages and frameworks
- **[Frontend Developer](frontend-developer.md)** - Modern web technologies and responsive design for any framework
- **[API Architect](api-architect.md)** - RESTful design, GraphQL, and framework-agnostic API architecture
- **[Tailwind Frontend Expert](tailwind-css-expert.md)** - Tailwind CSS styling, utility-first development, and responsive components

### 🔧 Core Team (4 agents)
- **[Code Archaeologist](code-archaeologist.md)** - Explores, documents, and analyzes unfamiliar or legacy codebases
- **[Code Reviewer](code-reviewer.md)** - Rigorous security-aware reviews with severity-tagged reports
- **[Performance Optimizer](action/Product-development/development/prompt/awesome-claude-agents/agents/core/performance-optimizer.md)** - Identifies bottlenecks and applies optimizations for scalable systems
- **[Documentation Specialist](documentation-specialist.md)** - Crafts comprehensive READMEs, API specs, and technical documentation
...
- [Creating Custom Agents](creating-agents.md) - Build specialists for your needs  
- [Best Practices](best-practices.md) - Get the most from your AI team
